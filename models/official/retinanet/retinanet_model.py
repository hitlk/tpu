...
def _learning_rate_schedule(base_learning_rate, lr_warmup_init, lr_warmup_step,
  ...
  lr_schedule = linear_warmup + [[1.0, lr_warmup_step], [0.1, lr_drop_step], [0.01, lr_drop_step + 200000]]
...
def _cls_loss(prediction_tensor,
  ...
  tf.check_numerics(per_entry_cross_ent, 'per_entry_cross_ent is nan of inf.')
  tf.check_numerics(prediction_probabilities, 'prediction_probabilities is nan or inf.')
